    ...
    <ul class="navbar-nav border-left flex-row ">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle text-nowrap px-3" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
          <img class="user-avatar rounded-circle mr-2" src="<?php print base_url('Shards-Dashboard/'); ?>images/avatars/boy.png" weight="30" height="37" alt="User Avatar">
          <span class="d-none d-md-inline-block"><?= $cetak; ?></span>
        </a>
        <div class="dropdown-menu dropdown-menu-small">
          <a class="dropdown-item" href="#">
            <i class="material-icons">&#xE7FD;</i>User : <?= $cetak  ?></a>
            <div class="dropdown-divider"></div>
            <a class="dropdown-item text-danger" href="<?php print base_url('login'); ?>">
