            ...
            <section class="content">
             ...
             <?php foreach($tb_telecenter as $data){ ?>
              ...
              <div class="card-body">
                ...
                <form class="form-horizontal" action="<?php echo site_url(). '/admin/input_keluarga/update'; ?>" role="form" method="post"> 
                    <div class="row">
                     ...
                     <div class="col-lg-6 col-md-6 col-sm-6">
                      ...
                      <div class="form-group">
                       ...
                       <a class="btn btn-danger" href="<?php echo base_url() ?>admin/input_keluarga/list">Batal</a>
                     </div>
                   </form>
                 <?php } ?>
               </section>
