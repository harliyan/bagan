...
<!-- icon -->
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php print base_url('adminlte/'); ?>plugins/iCheck/square/blue.css">
...
<body class="hold-transition login-page">
 ...
 <!--        <p class="mb-0">
  ...
  <!-- iCheck -->
  <script src="<?php print base_url('adminlte/'); ?>plugins/iCheck/icheck.min.js"></script>
  <script>
    $(function () {
      $('input').iCheck({
