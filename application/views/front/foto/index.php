      ...
      <div class="row">
        ...
        foreach ($doc_foto as $data): ?>
          <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="card-box">
              <h5 class="mb-3"><a href="<?php echo site_url() ?>foto/details/<?php echo $data->id ?>" style="color: #000000"><?php echo $data->judul; ?></h5>
             ...
             <p class="mt-2"><?php echo substr ($data -> caption, 0, 250); ?> <span class="text-info">(Read More)</span></p>
            </div>
          </div>
        <?php endforeach ?>
