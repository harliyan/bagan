  ...
  class StrukturOrganisasiController extends CI_Controller
  {
    ...
    public function index()
    {
     ...
     $this->load->view('adminlte3/input_keluarga/index_admin', $data);
    }

    public function tambah(){
    $this->load->view('superadmin/kelola_user');
    }
    ...
    public function edit($id)
    {
      ...
      $data['active_controller'] = 'kelola_user';
    ...
    { //fungsi delete
      ...
      redirect('superadmin/kelola_user'); //redirect
    }
